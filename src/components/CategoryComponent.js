  ...
  <div className="container-articles">
    <span className="border-bottom">
      <div className="row border-white w-auto cont-alig">
        <div className="col-md-2 small-pic" style={{margin: "0px"}}>
          <img className="img-fluid" src={bigimg} alt="book"/>
        </div>
        <div className="col-md-10">
          <div className="card-body">
            <h5 className="card-title">
              <a className="header-color-3" src={bigimg}>Tiny notice books</a>
            </h5>
...
<NavLink to="./product"><img src={bigimg} className="card-img-top" alt="Notice book Kitty"/></NavLink>
                <div className="card-body">
                  <h5 className="card-title ">Kitty</h5>
                  <p className="card-text ">0.50 EUR</p>
                  <a href="#" className="btn btn-primary align-center" onclick="addToCart()" id="addedToCartItem">Add to cart</a>
                </div>
              </div>
           </div>
           ...
           <div className="col text-center">
            <div className="card" style={{ width: '15rem'}}>
                <img src={bigimg} className="card-img-top" alt="Notice book Giraffe"/>
                <div className="card-body">
                  <h5 className="card-title">Giraffe</h5>
                  <p className="card-text">0.90 EUR.</p>
                  <a href="#" className="btn btn-primary align-center">Add to cart</a>
                </div>
              </div>
           </div>
           ...
           <div className="col text-center">
            <div className="card" style={{ width: '15rem'}}>
                <img src={bigimg} class="card-img-top" alt="Notice book Flamingo"/>
                <div className="card-body">
           ...
           <div className="col text-center">
            <div className="card" style={{ width: '15rem'}}>
                <img src={bigimg} className="card-img-top" alt="Notice book Future professions"/>
                <div className="card-body">
           ...
           <div className="col text-center">
            <div className="card" style={{ width: '15rem'}}>
                <img src={bigimg} className="card-img-top" alt="Notice book Cactus"/>
                <div className="card-body">
                  <h5 className="card-title">Cactus</h5>
                  <p className="card-text">1.20 EUR</p>
                  <a href="#" className="btn btn-primary" onclick="addToCart()" id="addedToCartItem">Add to cart</a>
                </div>
              </div>
           </div> 
      </div>
      ...
      <div className="row items" style={{margin: '13px'}}>
        ...
        <div className="col text-center">
         <div className="card" style={{ width: '15rem'}}>
             <img src={bigimg} class="card-img-top" alt="forest animals notice book"/>
             <div className="card-body">
        ...
        <div className="col text-center">
         <div className="card" style={{ width: '15rem'}}>
             <img src={bigimg} className="card-img-top" alt="Notice book Avocado"/>
             <div className="card-body">
        ...
        <div className="col text-center">
         <div className="card" style={{ width: '15rem'}}>
             <img src={bigimg} className="card-img-top" alt="Notice book Avocado mix" />
             <div className="card-body">
        ...
        <div className="col text-center">
         <div className="card" style={{ width: '15rem'}}>
             <img src={bigimg} className="card-img-top" alt="Notice book Crocodile" />
             <div className="card-body">
        ...
        <div className="col text-center">
         <div className="card" style={{ width: '15rem'}}>
             <img src={bigimg} className="card-img-top" alt="Notice book Little fox" />
             <div className="card-body">
